python main.py --model zigzag.inputs.examples.workload.resnet18 --mapping zigzag.inputs.examples.mapping.default_imc --accelerator zigzag.inputs.examples.hardware.Dimc
